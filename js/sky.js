...
$(document).ready(function() {
    ...
    // fire local
    $("#fire-local").click(function(e) {
        e.preventDefault();
		$(".current").fadeOut( 900, function() {
			$("#local").fadeIn( 1200 );
            $(".current").removeClass("current");
            $("#local").addClass("current");
        });
    });
    // fire home mobile
    ...
    // fire local mobile
    $("#fire-local-mobile").click(function(e) {
        e.preventDefault();
        $(".current").fadeOut( 900, function() {
            $("#local").fadeIn( 1200 );
            $(".current").removeClass("current");
    ...
    // fire closer
    $("#fire-about-closer, #fire-services-closer, #fire-contact-closer, #fire-local-closer").click(function(e) {
        e.preventDefault();
		$(".current").fadeOut( 900, function() {
			$(".upper-page").fadeIn( 1200 );
            $(".current").removeClass("current");
